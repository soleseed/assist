    ...
    <div>
        ...
        <form class="layui-form self-form">
          <div class="layui-form-item">
              <label for="isArrive" class="layui-form-label self-label">
          ...
          <div class="layui-form-item">
              <label for="trackId" class="layui-form-label self-label">
          ...
          <div class="layui-form-item">
              <label for="arriveTime" class="layui-form-label self-label">
          ...
          <div class="layui-form-item">
              <label for="trainCount" class="layui-form-label self-label">
          ...
          <div class="layui-form-item">
		    <label class="layui-form-label self-label">通知岗位</label>
