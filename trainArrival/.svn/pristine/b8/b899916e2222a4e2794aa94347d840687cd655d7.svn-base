  ...
  <div style="margin-top:10px;" class="layui-row" align="center">
	      <div class="layui-form-item search-form-item">
		    <div class="layui-inline">
          		<input type="text" id="userName" name="userName"  placeholder="用户名" autocomplete="off" class="layui-input input-search">
		    </div>
		    <div class="layui-inline">
          		<input type="text" id="aliases" name="aliases"  placeholder="用户姓名" autocomplete="off" class="layui-input input-search">
		    </div>
		    <div class="layui-inline">
          		<input type="text" id="postName" name="postName"    placeholder="岗位" autocomplete="off" class="layui-input input-search">
		    </div>
		    <div class="layui-inline">
          		<input type="text" id="deptName" name="deptName" placeholder="场" autocomplete="off" class="layui-input input-search">
		    </div>
		    <!-- <div class="layui-inline">
		    ...
		    <div class="layui-inline">
	          ...
	          <button class="layui-btn" onclick="x_admin_show('添加用户','${pageContext.request.contextPath }/user/toAdd',500,450)"><i class="layui-icon"></i>添加</button>
	          ...
	          <!-- <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="javascript:location.replace(location.href);" title="刷新">
       			 <i class="layui-icon-refresh" style="line-height:36px"></i></a> -->
		    </div>
		  </div>
      </div>
  </div>
