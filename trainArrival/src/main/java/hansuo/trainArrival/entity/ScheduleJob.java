...
public class ScheduleJob implements Serializable {
	...
	@Excel(name = "通知列检作业时分", orderNum = "6", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
	...
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8") // 页面展示格式
	@Excel(name = "列检作业完了时分", orderNum = "7", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
	private Date tFinishTime;

	/* 通知商检作业时分 */
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8") // 页面展示格式
	@Excel(name = "通知商检作业时分", orderNum = "8", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
	...
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8") // 页面展示格式
	@Excel(name = "商检作业完了时分", orderNum = "9", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
	private Date gFinishTime;

	/* 通知车号作业时分 */
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8") // 页面展示格式
	@Excel(name = "通知车号作业时分", orderNum = "10", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
	...
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8") // 页面展示格式
	@Excel(name = "通知防溜作业时分", orderNum = "11", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
	...
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8") // 页面展示格式
	@Excel(name = "通知列尾作业时分", orderNum = "15", exportFormat = "yyyy-MM-dd HH:mm:ss", width = 20)
	...
	/* 防溜位数/撤除防溜位数 */
	//@Excel(name = "防溜位数", orderNum = "12", width = 10)
	private Integer antiRunningCount;

	/* 防溜位数/撤除防溜位数 */
	@Excel(name = "列尾设备主机号", orderNum = "13", width = 15)
	private String deviceNo;

	/* 通知防溜人员 */
	//@Excel(name = "通知防溜人员 ", orderNum = "14", width = 15)
	private String antiRunningMan;

	/* 作业状态 1-9:进行中，10已完成，0未开始 */
	@Excel(name = "作业状态", orderNum = "5", replace = { "未开始_-1", "未开始_0", "进行中_1", "已完成_2", "已确认_3" })
	...
	// 车次编号
	@Excel(name = "防溜/撤溜位置", orderNum = "16", width = 15)
	private String antiLocation;
	...
	public String getAntiLocation() {
		return antiLocation;
	}

	public void setAntiLocation(String antiLocation) {
		this.antiLocation = antiLocation;
	}
